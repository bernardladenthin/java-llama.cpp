 ...
 *
 * <p>{@link #LLAMA_CPP_VERSION} is a pure-Java string ({@code "b10519"}) that mirrors the
 ...
 * plus the resolved upstream commit, e.g. {@code "b10519-<commit>"} — call
...
public final class LlamaCppVersion {
    ...
    /**
     * The pinned llama.cpp release tag this library was built against, e.g. {@code "b10519"}.
     *
     ...
     */
    public static final String LLAMA_CPP_VERSION = "b10519";
