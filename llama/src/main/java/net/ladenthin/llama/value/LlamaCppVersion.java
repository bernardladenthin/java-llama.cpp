 ...
 *
 * <p>{@link #LLAMA_CPP_VERSION} is a pure-Java string ({@code "b10299"}) that mirrors the
 ...
 * plus the resolved upstream commit, e.g. {@code "b10299-<commit>"} — call
...
public final class LlamaCppVersion {
    ...
    /**
     * The pinned llama.cpp release tag this library was built against, e.g. {@code "b10299"}.
     *
     ...
     */
    public static final String LLAMA_CPP_VERSION = "b10299";
