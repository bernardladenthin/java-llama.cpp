...
/**
 * Pooling strategy applied to token embeddings when {@link de.kherud.llama.ModelParameters#enableEmbedding()}
 * is active.
 *
...
public enum PoolingType {
     ...
     * {@link de.kherud.llama.ModelParameters#setPoolingType(PoolingType)} intentionally
     ...
     * Requires a model loaded with {@link de.kherud.llama.ModelParameters#enableReranking()};
