...
Current llama.cpp pinned version: **b10207**
...
git clone --depth 1 --branch b10207 https://github.com/ggml-org/llama.cpp /tmp/lc
...
Because `sccache` is **content-addressed** and llama.cpp is pinned (`GIT_TAG b10207`), the
...
llama.cpp is fetched via CMake FetchContent, pinned to `GIT_TAG b10207`.
