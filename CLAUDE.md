...
Current llama.cpp pinned version: **b11062**
...
git clone --depth 1 --branch b11062 https://github.com/ggml-org/llama.cpp /tmp/lc
...
Because `sccache` is **content-addressed** and llama.cpp is pinned (`GIT_TAG b11062`), the
...
**Current total: 551 tests (all passing).**
