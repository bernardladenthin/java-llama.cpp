...
Current llama.cpp pinned version: **b10236**
...
git clone --depth 1 --branch b10236 https://github.com/ggml-org/llama.cpp /tmp/lc
...
Because `sccache` is **content-addressed** and llama.cpp is pinned (`GIT_TAG b10236`), the
...
llama.cpp is fetched via CMake FetchContent, pinned to `GIT_TAG b10236`.
