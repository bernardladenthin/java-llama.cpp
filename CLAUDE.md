...
Current llama.cpp pinned version: **b11069**
...
git clone --depth 1 --branch b11069 https://github.com/ggml-org/llama.cpp /tmp/lc
...
Because `sccache` is **content-addressed** and llama.cpp is pinned (`GIT_TAG b11069`), the
...
**Current total: 558 tests (all passing).**

#### Upstream source location (in CMake build tree)

llama.cpp is fetched via CMake FetchContent, pinned to `GIT_TAG b11069`.
