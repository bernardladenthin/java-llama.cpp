...
Current llama.cpp pinned version: **b10256**
...
git clone --depth 1 --branch b10256 https://github.com/ggml-org/llama.cpp /tmp/lc
...
Because `sccache` is **content-addressed** and llama.cpp is pinned (`GIT_TAG b10256`), the
