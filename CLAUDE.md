...
Current llama.cpp pinned version: **b10226**
...
git clone --depth 1 --branch b10226 https://github.com/ggml-org/llama.cpp /tmp/lc
...
Because `sccache` is **content-addressed** and llama.cpp is pinned (`GIT_TAG b10226`), the
...
llama.cpp is fetched via CMake FetchContent, pinned to `GIT_TAG b10226`.
