...
Current llama.cpp pinned version: **b10241**
...
git clone --depth 1 --branch b10241 https://github.com/ggml-org/llama.cpp /tmp/lc
...
Because `sccache` is **content-addressed** and llama.cpp is pinned (`GIT_TAG b10241`), the
...
llama.cpp is fetched via CMake FetchContent, pinned to `GIT_TAG b10241`.
