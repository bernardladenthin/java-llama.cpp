...
| ~b8854–b8887 | `common/chat.h` | `common_chat_msg_diff_to_json_oaicompat` removed; equivalent logic moved to `tools/server/server-chat.cpp`; project defines local `server_chat_msg_diff_to_json_oaicompat` in `server.hpp` |
