...
Current llama.cpp pinned version: **b11052**
...
git clone --depth 1 --branch b11052 https://github.com/ggml-org/llama.cpp /tmp/lc
...
Because `sccache` is **content-addressed** and llama.cpp is pinned (`GIT_TAG b11052`), the
...
llama.cpp is fetched via CMake FetchContent, pinned to `GIT_TAG b11052`.
