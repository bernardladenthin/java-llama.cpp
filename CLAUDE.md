...
Current llama.cpp pinned version: **b10265**
...
git clone --depth 1 --branch b10265 https://github.com/ggml-org/llama.cpp /tmp/lc
...
Because `sccache` is **content-addressed** and llama.cpp is pinned (`GIT_TAG b10265`), the
...
llama.cpp is fetched via CMake FetchContent, pinned to `GIT_TAG b10265`.
