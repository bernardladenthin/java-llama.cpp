...
Current llama.cpp pinned version: **b10436**
...
git clone --depth 1 --branch b10436 https://github.com/ggml-org/llama.cpp /tmp/lc
...
Because `sccache` is **content-addressed** and llama.cpp is pinned (`GIT_TAG b10436`), the
...
llama.cpp is fetched via CMake FetchContent, pinned to `GIT_TAG b10436`.
