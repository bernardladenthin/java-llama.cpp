...
Current llama.cpp pinned version: **b10398**
...
git clone --depth 1 --branch b10398 https://github.com/ggml-org/llama.cpp /tmp/lc
...
Because `sccache` is **content-addressed** and llama.cpp is pinned (`GIT_TAG b10398`), the
...
llama.cpp is fetched via CMake FetchContent, pinned to `GIT_TAG b10398`.
