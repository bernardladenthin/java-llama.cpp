...
Current llama.cpp pinned version: **b10507**
...
git clone --depth 1 --branch b10507 https://github.com/ggml-org/llama.cpp /tmp/lc
...
Because `sccache` is **content-addressed** and llama.cpp is pinned (`GIT_TAG b10507`), the
...
llama.cpp is fetched via CMake FetchContent, pinned to `GIT_TAG b10507`.
