...
Current llama.cpp pinned version: **b10639**
...
git clone --depth 1 --branch b10639 https://github.com/ggml-org/llama.cpp /tmp/lc
...
Because `sccache` is **content-addressed** and llama.cpp is pinned (`GIT_TAG b10639`), the
...
**Current total: 504 tests (all passing).**

#### Upstream source location (in CMake build tree)

llama.cpp is fetched via CMake FetchContent, pinned to `GIT_TAG b10639`.
